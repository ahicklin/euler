...
public class Problem11 {
	...
	public static void main(String[] args) {
		...
		int anArray[][] =  {
				...
				{ 22, 31, 16, 71, 51, 67, 63, 89, 41, 92, 36, 54, 22, 40, 40,
						28, 66, 33, 13, 80 },
				{ 24, 47, 32, 60, 99, 3, 45, 02, 44, 75, 33, 53, 78, 36, 84,
						20, 35, 17, 12, 50 },
				...
				{ 24, 55, 58, 5, 66, 73, 99, 26, 97, 17, 78, 78, 96, 83, 14,
						88, 34, 89, 63, 72 },
				{ 21, 36, 23, 9, 75, 00, 76, 44, 20, 45, 35, 14, 0, 61, 33, 97,
						34, 31, 33, 95 },
				...
				{ 19, 80, 81, 68, 5, 94, 47, 69, 28, 73, 92, 13, 86, 52, 17,
						77, 4, 89, 55, 40 },
				{ 4, 52, 8, 83, 97, 35, 99, 16, 07, 97, 57, 32, 16, 26, 26, 79,
						33, 27, 98, 66 },
		...
		for (int i = 0; i < 17; i++){
			for (int j = 0; j < 17; j++){
				num = anArray[i][j] * anArray[i + 1][j + 1] * anArray[i + 2][j + 2] * anArray[i + 3][j + 3];
				if (num > answer){
					answer = num;
			}
		}
	...
	for (int i = 0; i < 17; i++){
		for (int j = 0; j < 20; j++){
			num = anArray[i][j] * anArray[i + 1][j] * anArray[i + 2][j] * anArray[i + 3][j];
			if (num > answer){
				answer = num;
		}
	}
		...
		for (int i = 0; i < 20; i++){
			for (int j = 0; j < 17; j++){
			num = anArray[i][j] * anArray [i][j + 1] * anArray[i][j + 2] * anArray[i][j + 3];
		if (num > answer){
			answer = num;
			}
		}
